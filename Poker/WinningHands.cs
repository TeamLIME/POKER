...
namespace Poker
{
    class WinningHands
    {
        public static void rStraightFlush(ref double current, ref double Power, int[] st1, int[] st2, int[] st3, int[] st4,
            List<Type> winningHands, Type sorted, ref double type, ref  int i, int[] Reserve)
        {
            if (current >= -1)
            {
                if (st1.Length >= 5)
        ...
        public static void rFourOfAKind(ref double current, ref double Power, int[] Straight,
            List<Type> winningHands, Type sorted, ref double type, ref  int i, int[] Reserve)
        {
            if (current >= -1)
            {
        ...
        public static void rFullHouse(ref double current, ref double Power, ref bool done, int[] Straight,
            List<Type> winningHands, Type sorted, ref double type, ref  int i, int[] Reserve)
        {
            if (current >= -1)
            {
        ...
        public static void rFlush(ref double current, ref double Power, ref bool vf, int[] Straight1,
            List<Type> winningHands, Type sorted, ref double type, ref  int i, int[] Reserve)
        {
            if (current >= -1)
            {
        ...
        public static void rStraight(ref double current, ref double Power, int[] Straight,
            List<Type> winningHands, Type sorted, ref double type, ref  int i, int[] Reserve)
        {
            if (current >= -1)
            {
        ...
        public static void rThreeOfAKind(ref double current, ref double Power, int[] Straight,
            List<Type> winningHands, Type sorted, ref double type, ref  int i, int[] Reserve)
        {
            if (current >= -1)
            {
        ...
        public static void rTwoPair(ref double current, ref double Power,
            List<Type> winningHands, Type sorted, ref double type, ref  int i, int[] Reserve)
        {
            if (current >= -1)
            {
        ...
        public static void rPairTwoPair(ref double current, ref double Power,
            List<Type> winningHands, Type sorted, ref double type, ref  int i, int[] Reserve)
        {
            if (current >= -1)
            {
        ...
        public static void rPairFromHand(ref double current, ref double Power, 
            List<Type> winningHands, Type sorted, ref double type, ref  int i, int[] Reserve)
        {
            if (current >= -1)
            {
        ...
        public static void rHighCard(ref double current, ref double Power,
            List<Type> winningHands, Type sorted, ref double type, ref  int i, int[] Reserve)
        {
            if (current == -1)
            {
